# De¹ Exchange Widget + AppKit Example
This project shows an example of how to use the De¹ Exchange Widget with the AppKit from Reown
...
This example fetches a list of chains from De¹ Exchange using the `useAvailableChains` hook, and they are passed to the AppKit modal.
