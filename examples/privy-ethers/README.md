# De¹ Exchange Widget + Privy + Ethers Example
This project shows an example of how to use the De¹ Exchange Widget with the Privy wallet and ethers library.
...
## Using chains from De¹ Exchange
This example fetches a list of chains from De¹ Exchange using the `useAvailableChains` hook, and they are passed to the Privy provider.
...
### Ethers
Since De¹ Exchange Widget and Privy are tightly coupled with Wagmi. 
