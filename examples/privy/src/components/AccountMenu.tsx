...
export function AccountMenu({ handleClose, anchorEl, open }: AccountMenuProps) {
  const { user, logout, ready, linkEmail, linkPasskey, exportWallet } = usePrivy()
    ...
    >
      <MenuList>
        ...
        {solanaWallets.length > 0 && (
          <MenuItem onClick={() => exportSolanaWallet({ address: solanaWallets[0].address })}>
            <ListItemIcon>
              <VpnKeyIcon fontSize="small" />
            </ListItemIcon>
