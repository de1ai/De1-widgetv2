...
interface SwapParams {
  ...
  toMsg: Asset
  inAmount: string
  slippage_tolerance: string | number // Note: De1Service uses number, keep as is or unify
...
const NATIVE_TOKENS: Record<number, Asset> = {
  1: {
    ...
    icon: '//s3.de1.exchange/images/1637894743832_8242841824007741.png',
  },
  56: {
    chainId: 56,
    address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
    ...
    symbol: 'BNB',
    decimals: 18,
    icon: 'https://s3.de1.exchange/token_logos/logos/bsc/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png',
  },
  137: {
    chainId: 137,
    address: '0x0000000000000000000000000000000000001010',
    icon: 'https://s3.de1.exchange/images/1637561049975_1903381661429342.png',
    name: 'Matic',
    symbol: 'MATIC',
    decimals: 18,
  },
  43114: {
    ...
    name: 'Avalanche',
    symbol: 'AVAX',
    icon: 'https://ethapi.de1.exchange/logos/avax/0x0000000000000000000000000000000000000000.png',
    decimals: 18,
  },
  250: {
    chainId: 250,
    ...
    symbol: 'FTM',
    decimals: 18,
    icon: 'https://ethapi.de1.exchange/logos/fantom/0x0000000000000000000000000000000000000000.png',
  },
  42161: {
    name: 'ETH',
    address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
    decimals: 18,
    symbol: 'ETH',
    icon: 'https://s3.de1.exchange/images/1660286550539_3465620840567112.png',
    chainId: 42161,
  },
  10: {
    name: 'Etherum',
    ...
    decimals: 18,
    symbol: 'ETH',
    icon: 'https://s3.de1.exchange/images/1661137422943_3757149396730206.png',
    chainId: 10,
  },
  324: {
    chainId: 324,
    ...
    decimals: 18,
    symbol: 'ETH',
    icon: 'https://s3.de1.exchange/token_logos/logos/1678448299500_8777733284012612.png',
  },
  8453: {
    chainId: 8453,
    name: 'Ethereum',
    ...
    decimals: 18,
    symbol: 'ETH',
    icon: 'https://s3.de1.exchange/token_logos/logos/1704872214606_042688653920736286.png',
  },
  7565164: {
    chainId: 7565164,
    name: 'SOL',
    ...
    decimals: 9,
    symbol: 'SOL',
    icon: 'https://s3.de1.exchange/token_logos/logos/solana/So11111111111111111111111111111111111111112.png',
  },
  14: {
    chainId: 14,
    name: 'Flare',
...
export class DebridgeService {
  ...
  static async buildBridgeData(
    ...
    if (route && route.bridgeRoute && route.bridgeRoute.transactionRequest) {
      ...
      // We need to encode it for passing to De¹ Exchange aggregation contract (if applicable)
      ...
      try {
        ...
        // De¹ Exchange aggregation contract might need explicit fee parameter. Here assuming fixFee.
        ...
        // Return final built data, this data will be sent to De¹ Exchange aggregator contract
