import type { SDKConfig } from '@de1/widget-sdk'
import { config, createConfig } from '@de1/widget-sdk'
    ...
    try {
      ...
      const _config: SDKConfig = {
        ...
        routeOptions: {
          ...
          referrer: widgetConfig.evmReferrer?.address || widgetConfig.referrer?.address,
