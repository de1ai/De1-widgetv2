import type { De1StepExtended } from '@de1/widget-sdk'
...
const getFirstExecutionProcess = (step: De1StepExtended) =>
  step.execution?.process.at(0)

const getExecutionProcess = (step: De1StepExtended) =>
  step.execution?.process.at(-1)

const getStartTimestamp = (step: De1StepExtended) =>
