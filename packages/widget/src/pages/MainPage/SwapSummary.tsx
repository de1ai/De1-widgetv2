...
export const SwapSummary: React.FC = () => {
  ...
  if (route) {
    ...
    estGasFee = (route as { estimatedGasFee?: string }).estimatedGasFee || '0';

    const apiPriceImpact = (route as { price_impact?: string }).price_impact
  ...
  return (
    <SummaryBox>
      ...
      <SummaryRow>
        ...
        <Typography variant="body2">{priceImpactDisplay}</Typography>
      </SummaryRow>
    </SummaryBox>
  );
};
