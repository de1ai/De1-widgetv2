...
const ExchangeRateBottomSheetContent = ({ data, onCancel, onContinue }) => {
    ...
    return (_jsxs(Box, { ref: ref, sx: {
            p: 3,
                            ...
                            fontSize: 18,
                            fontWeight: 700,
                        }, children: t('warning.title.rateChanged') })] }), _jsx(Typography, { sx: {
                    py: 1,
                }, children: t('warning.message.rateChanged') }), _jsxs(Box, { sx: {
                    display: 'flex',
                    justifyContent: 'space-between',
                    mt: 1,
                }, children: [_jsx(Typography, { children: t('main.quotedAmount') }), _jsxs(Typography, { sx: {
                            fontWeight: 600,
                        }, children: [t('format.tokenAmount', {
                                value: formatTokenAmount(BigInt(data.oldToAmount), data.toToken.decimals),
                            }), ' ', data?.toToken.symbol] })] }), _jsxs(Box, { sx: {
                    display: 'flex',
                    justifyContent: 'space-between',
                    mt: 0.25,
                }, children: [_jsx(Typography, { children: t('main.currentAmount') }), _jsxs(Typography, { sx: {
                            fontWeight: 600,
                        }, children: [t('format.tokenAmount', {
                                value: formatTokenAmount(BigInt(data?.newToAmount), data?.toToken.decimals),
                            }), ' ', data?.toToken.symbol] })] }), _jsxs(Box, { sx: {
                    display: 'flex',
                    justifyContent: 'space-between',
                    mt: 0.25,
                }, children: [_jsx(Typography, { children: t('main.rateChange') }), _jsxs(Typography, { sx: {
                            fontWeight: 600,
                        }, children: [rateChange, "%"] })] }), _jsxs(Box, { sx: {
                    display: 'flex',
                    mt: 3,
