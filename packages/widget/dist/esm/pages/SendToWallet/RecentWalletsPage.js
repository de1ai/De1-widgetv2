...
import { ContentCopyRounded, DeleteOutline, History, MoreHoriz, OpenInNewRounded, TurnedInNot, } from '@mui/icons-material';
...
export const RecentWalletsPage = () => {
    ...
    const { removeRecentWallet, addBookmark, setSelectedBookmark, addRecentWallet, } = useBookmarkActions();
