...
export const WalletMenu = ({ onClose }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Box, { sx: {
                    ...
                    return (_jsxs(MenuItem, { disableTouchRipple: true, children: [_jsxs(Box, { sx: {
                                    flex: 1,
                                    display: 'flex',
                                    alignItems: 'center',
                                }, children: [chain?.logoURI ? (_jsx(Badge, { overlap: "circular", anchorOrigin: { vertical: 'bottom', horizontal: 'right' }, badgeContent: _jsx(SmallAvatar, { src: chain?.logoURI, alt: chain?.name, children: chain?.name[0] }), sx: { marginRight: 1.5 }, children: _jsx(AvatarMasked, { src: getConnectorIcon(account.connector), alt: account.connector?.name, children: account.connector?.name[0] }) })) : (_jsx(Avatar, { src: getConnectorIcon(account.connector), alt: account.connector?.name, sx: {
                                            marginRight: 1.5,
                                        }, children: account.connector?.name[0] })), walletAddress] }), _jsxs(Box, { sx: {
                                    ml: 2,
                                }, children: [_jsx(IconButton, { size: "medium", onClick: handleCopyAddress, children: _jsx(ContentCopyRounded, {}) }), _jsx(IconButton, { size: "medium", component: "a", onClick: onClose, href: account.address
                                            ? getAddressLink(account.address, chain)
                                            : undefined, target: "_blank", children: _jsx(OpenInNewRounded, {}) }), _jsx(DisconnectIconButton, { account: account })] })] }, account.address));
                }) }), _jsx(Button, { onClick: connect, fullWidth: true, startIcon: _jsx(PowerSettingsNewRounded, {}), sx: {
                    marginTop: 1,
