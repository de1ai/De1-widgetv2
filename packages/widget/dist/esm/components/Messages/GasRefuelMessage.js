...
export const GasRefuelMessage = (props) => {
    ...
    return (_jsx(Collapse, { timeout: 225, in: showGasRefuelMessage, unmountOnExit: true, mountOnEnter: true, children: _jsx(AlertMessage, { icon: _jsx(EvStation, {}), title: _jsxs(Box, { sx: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    flexGrow: 1,
                            ...
                            fontWeight: 700,
                        }, children: t('info.title.autoRefuel', { chainName: chain?.name ?? '' }) }), _jsx(InfoMessageSwitch, { checked: enabledAutoRefuel, onChange: onChange })] }), ...props, children: _jsx(Collapse, { timeout: 225, in: enabledAutoRefuel, unmountOnExit: true, mountOnEnter: true, children: _jsx(Typography, { variant: "body2", sx: {
                        px: 2,
                        pt: 1,
