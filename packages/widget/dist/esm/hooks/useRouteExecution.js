import { useAccount, useAccountDisconnect, useWalletMenu, } from '@de1/wallet-management';
import { updateRouteExecution } from '@de1/widget-sdk';
...
import { useRouteExecutionStore, useRouteExecutionStoreContext, } from '../stores/routes/RouteExecutionStore.js';
import { getUpdatedProcess, isRouteActive, isRouteDone, isRouteFailed, } from '../stores/routes/utils.js';
...
export const useRouteExecution = ({ routeId, executeInBackground, onAcceptExchangeRateUpdate, }) => {
    ...
    const chain = getChainById(routeExecution?.route.fromChainId);
