...
export const useToAddressAutoPopulate = () => {
    ...
    return useCallback(({ formType, selectedToAddress, selectedChainId, selectedOppositeTokenAddress, selectedOppositeChainId, }) => {
        ...
        const destinationChainType = formType === 'from'
        ...
        if (selectedToAddress) {
            const selectedToAddressChainType = getChainTypeFromAddress(selectedToAddress);
