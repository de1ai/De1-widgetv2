...
const processStatusMessages = {
    TOKEN_ALLOWANCE: {
        ...
        ACTION_REQUIRED: (t, step) => t('main.process.tokenAllowance.actionRequired', {
            tokenSymbol: step.action.fromToken.symbol,
        }),
        PENDING: (t, step) => t('main.process.tokenAllowance.pending', {
            tokenSymbol: step.action.fromToken.symbol,
        }),
        DONE: (t, step) => t('main.process.tokenAllowance.done', {
            tokenSymbol: step.action.fromToken.symbol,
        }),
    },
    SWITCH_CHAIN: {
    ...
    SWAP: {
        ...
        DONE: (t, _, subvariant, subvariantOptions) => subvariant === 'custom'
...
export function getProcessMessage(t, getChainById, step, process, subvariant, subvariantOptions) {
    ...
    const isPegasusBridge = step.type === 'bridge' &&
        step.quoteData
