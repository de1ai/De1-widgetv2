 ...
 */
export declare const useToAddressAutoPopulate: () => ({ formType, selectedToAddress, selectedChainId, selectedOppositeTokenAddress, selectedOppositeChainId, }: UpdateToAddressArgs) => string;
