...
`;
export const createTheme = (mode, widgetTheme = {}) => {
    const primaryMainColor = widgetTheme.palette?.primary?.main ??
        palette.primary.main;
    const primaryLightColor = lighten(primaryMainColor, 0.84);
    const primaryDarkColor = darken(primaryMainColor, 0.2);
    const secondaryMainColor = widgetTheme.palette?.secondary?.main ??
        palette.secondary.main;
    const contrastButtonColor = getContrastRatio(palette.common.white, primaryMainColor) >= 3
        ? palette.common.white
        : palette.common.black;
    const contrastTextButtonColor = getContrastRatio(palette.common.white, alpha(primaryMainColor, 0.08)) >= 3
        ? palette.common.white
        : palette.common.black;
    const borderRadiusSecondary = widgetTheme.shape?.borderRadiusSecondary ?? shape.borderRadiusSecondary;
        ...
        components: {
          ...
          `,
                ...
                styleOverrides: {
                    root: ({ ownerState }) => ({
                        ...
                        '&.Mui-disabled, &.Mui-disabled:hover': {
                            color: alpha(mode === 'light' ? palette.common.black : palette.common.white, 0.56),
                            cursor: 'not-allowed',
                            pointerEvents: 'auto',
                        },
                    ...
                    contained: ({ ownerState }) => ({
                        ...
                        ...getStyleOverrides('MuiButton', 'contained', widgetTheme, ownerState),
                    }),
                    sizeMedium: ({ ownerState }) => ({
                        ...
                        ...getStyleOverrides('MuiButton', 'sizeMedium', widgetTheme, ownerState),
                    }),
                },
            },
            MuiIconButton: {
                ...
                styleOverrides: {
                    ...
                    root: ({ ownerState }) => ({
                        ...
                        ...getStyleOverrides('MuiIconButton', 'root', widgetTheme, ownerState),
                    }),
                },
            },
            MuiAvatar: {
            ...
            MuiTypography: {
                defaultProps: {
                    component: 'div',
                    ...widgetTheme.components?.MuiTypography?.defaultProps,
                },
            },
        },
    });
