...
import type { Action, FeeCost, De1Step, StepToolDetails } from './step.js'
...
export interface Route {
  ...
  // Add data property for extended route information
  data?: {
...
export type GasRecommendationResponse = {
  ...
  serviceFee?: TokenBalance // De¹ Exchange fee for providing the service
...
export type RelayerQuoteResponse = RelayerResponse<De1Step>

export type RelayRequest = De1Step
