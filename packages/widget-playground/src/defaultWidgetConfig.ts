...
export const widgetBaseConfig: WidgetConfig = {
  ...
  // defaultChain: 137,
  // defaultFromToken: '0x2791bca1f2de4661ed88a30c99a7a9449aa84174',
  // defaultToToken: '0x7f5c764cbc14f9669b88837ca1490cca17c31607',
  // fromAmount: '20',
  // toAddress: {
  //   name: 'Jenny',
  ...
  // 'pegasus', 'lifi', 'relay', 'near intents', 'mayan'
  bridges: {
    // allow: ['pegasus'],
    // deny: ['mayan'],
    showSettings: true,
  ...
  // },
  // explorerUrls: {
  //   42161: ['https://de1.exchange/'], // Arbitrum
