...
import type { BookmarkProps } from '@de1/widget'
...
export const BookmarkStoreControls = () => {
  ...
  const handleFill = () => {
    ...
    localStorage.setItem('de1-bookmarks', JSON.stringify(newState))
    window.location.reload()
  }

  const handleEmpty = () => {
    localStorage.setItem('de1-bookmarks', JSON.stringify(store))
    window.location.reload()
  }
