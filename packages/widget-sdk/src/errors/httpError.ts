import type { UnavailableRoutes } from '@de1/widget-types'
import type { ExtendedRequestInit } from '../types/request.js'
import { BaseError } from './baseError.js'
import { De1ErrorCode } from './constants.js'
...
const statusCodeToErrorClassificationMap = new Map([
  [
    400,
    {
      ...
      code: De1ErrorCode.ValidationError,
    },
  ],
  [404, { type: ErrorName.NotFoundError, code: De1ErrorCode.NotFound }],
  [
    409,
    {
      type: ErrorName.SlippageError,
      code: De1ErrorCode.SlippageError,
      message: ErrorMessage.SlippageError,
    },
  ],
  [
    500,
    { type: ErrorName.ServerError, code: De1ErrorCode.InternalError },
  ],
])
...
const getErrorClassificationFromStatusCode = (code: number) =>
  statusCodeToErrorClassificationMap.get(code) ?? {
    ...
    code: De1ErrorCode.InternalError,
  }
